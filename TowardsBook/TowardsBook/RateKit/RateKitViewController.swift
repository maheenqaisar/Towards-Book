...
open class RateKitViewController: UIViewController {
    
    // MARK: - delegate
    public var delegate: RateKitViewControllerDelegate?
    ...
    // MARK: - animation
    public var animationType: RateKitAnimationType = .bounce
    public var animationDuration: Float = 0.5
    
    // MARK: - haptic
    public var hapticMoments: [RateKitHapticMoments] = [.willChange, .willSubmit]
    
    // MARK: - rating
    public var unselectedMarkImage: UIImage? = UIImage(named: "star_unselected.png", in: Bundle(for: RateKitViewController.self), compatibleWith: nil)
    public var selectedMarkImage: UIImage? = UIImage(named: "star_selected.png", in: Bundle(for: RateKitViewController.self), compatibleWith: nil)
    ...
    open override func viewDidLoad() {
        ...
        if showCloseButton {
            let closeButtonImage = UIImage(named: "close.png", in: Bundle(for: RateKitViewController.self), compatibleWith: nil)
